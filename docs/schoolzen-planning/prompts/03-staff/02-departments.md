Read every .md file in docs/schoolzen-planning/v1/staff/ in full — this task builds ONLY the "Departments" page, but the whole module's .md files give the shared context (schema relationships, cross-page rules) you need.
...
Match docs/schoolzen-planning/v1/staff/departments.html pixel-for-pixel.

Specific rules for this page: simple CRUD, same shell as Designations.
...
New collections/fields and new API routes only — do not modify any existing legacy schema or route in place. Wire this page behind /v2/staff/departments; do not touch or redirect the legacy equivalent yet.
